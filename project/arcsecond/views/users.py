...
def UserProfileView(request):
    ...
    return render_to_response('arcsecond/user-profile.html', {}, RequestContext(request))
    # else:
    #     context_data["username"] = username
    #     return render_to_response('arcsecond/no-user-profile.html', context_data, RequestContext(request))
