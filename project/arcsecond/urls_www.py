...
if settings.DEBUG:
    ...
    urlpatterns += patterns('', url(r'^1/observingsites_debug/(?P<name>[\s\+0-9a-zA-Z_-]+)/$', views.ObservingSiteDetail.as_view(), name="observingsite-detail"))
    urlpatterns += patterns('', url(r'^1/coordinates_debug/(?P<pk>\d+)/$', views.SiteCoordinatesDetail.as_view(), name="coordinates-detail"))
