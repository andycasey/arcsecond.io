...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AstronomicalFlux.unit'
        db.add_column(u'iobserve_astronomicalflux', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AstronomicalFlux.unit'
        db.delete_column(u'iobserve_astronomicalflux', 'unit')
    ...
    models = {
        ...
        'iobserve.astronomicalflux': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'unit': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
