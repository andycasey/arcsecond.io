...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'iobserve_objecttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('astronomical_object', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='object_types', null=True, to=orm['iobserve.AstronomicalObject'])),
        ))
        db.send_create_signal('iobserve', ['ObjectType'])

        # Deleting field 'AstronomicalCoordinates.source'
        db.delete_column(u'iobserve_astronomicalcoordinates', 'source')

        # Adding field 'AstronomicalCoordinates.right_ascension_units'
        db.add_column(u'iobserve_astronomicalcoordinates', 'right_ascension_units',
                      self.gf('django.db.models.fields.CharField')(default='degrees', max_length=100),
                      keep_default=False)

        # Adding field 'AstronomicalCoordinates.declination_units'
        db.add_column(u'iobserve_astronomicalcoordinates', 'declination_units',
                      self.gf('django.db.models.fields.CharField')(default='degrees', max_length=100),
                      keep_default=False)


        # Changing field 'Alias.name'
        db.alter_column(u'iobserve_alias', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'iobserve_objecttype')
        ...
        # Deleting field 'AstronomicalCoordinates.right_ascension_units'
        db.delete_column(u'iobserve_astronomicalcoordinates', 'right_ascension_units')

        # Deleting field 'AstronomicalCoordinates.declination_units'
        db.delete_column(u'iobserve_astronomicalcoordinates', 'declination_units')


        # Changing field 'Alias.name'
        db.alter_column(u'iobserve_alias', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'iobserve.astronomicalinfo': {
            'Meta': {'object_name': 'AstronomicalInfo'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'string_unit': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'string_value': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
